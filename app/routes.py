...
def health_check():
    ...
    try:
        ...
        return (
            jsonify({'status': 'healthy', 'database': 'connected'}),
            200,
        )
    except Exception:
        return (
...
def create_todo():
    ...
    try:
        ...
        return (
            jsonify(
                {'success': True, 'data': todo.to_dict(), 'message': 'Todo created successfully'}
            ),
            201,
        )
    except SQLAlchemyError:
...
def update_todo(todo_id):
    ...
    try:
        ...
        return (
            jsonify(
                {'success': True, 'data': todo.to_dict(), 'message': 'Todo updated successfully'}
            ),
            200,
        )
    except SQLAlchemyError:
